...
cs105.session(Session(3, ))
cs105.session(Session(4, Abdul-Wahid))
cs105.session(Session(4, Abdul-Wahid))
cs105.session(Session(5, Abdul-Wahid))
cs105.session(Session(5, Abdul-Wahid))
cs105.session(Session(6, Abdul-Wahid))
cs105.session(Session(6, Abdul-Wahid))
cs105.session(Session(7, Abdul-Wahid))
cs105.session(Session(7, Abdul-Wahid))
cs105.session(Session(8, Abdul-Wahid))
cs105.session(Session(8, Abdul-Wahid))
cs105.session(Session(9, Abdul-Wahid))
cs105.session(Session(9, Abdul-Wahid))
...
cs367.session(Session(6, Abdul-Wahid))
cs367.session(Session(9, Abdul-Wahid))
