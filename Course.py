...
cs392 = Course('cs392', 1, [cs301], True, 0)
cs392.session(Session(1, ))
cs392.session(Session(2, ))
cs392.session(Session(3, ))
cs392.session(Session(4, Montgomery))
cs392.session(Session(5, Montgomery))
cs392.session(Session(6, Montgomery))
cs392.session(Session(7, Grecos))
cs392.session(Session(8, Grecos))
cs392.session(Session(9, Grecos))
...
cs481.session(Session(2, Anvik))
cs481.session(Session(2, Jagodzinski))
cs481.session(Session(2, Johnson))
cs481.session(Session(2, Kovalerchuk))
cs481.session(Session(2, ))
cs481.session(Session(5, Andonie))
cs481.session(Session(5, Davendra))
cs481.session(Session(5, Vajda))
cs481.session(Session(5, Guerinoni))
cs481.session(Session(5, Lulofs))
cs481.session(Session(5, Schwing))
cs481.session(Session(5, Popescu))
cs481.session(Session(8, Kovalerchuk))
cs481.session(Session(8, Vajda))
cs481.session(Session(8, Zeljkovic))
cs481.session(Session(8, Davendra))

cs489 = Course('cs489', 1, [cs325, cs480], True, 0)
...
cs492 = Course('cs492', 2, [cs392, cs302, cs312], True, 0)
cs492.session(Session(1, ))
cs492.session(Session(2, ))
cs492.session(Session(3, ))
cs492.session(Session(4, Montgomery))
cs492.session(Session(5, Montgomery))
cs492.session(Session(6, Montgomery))
cs492.session(Session(7, Grecos))
cs492.session(Session(8, Grecos))
cs492.session(Session(9, Grecos))
...
cs450.session(Session(5, Guerinoni))
cs450.session(Session(9, Zeljkovic))

cs455 = Course('cs455', 4, [cs302], False, 0)
cs455.session(Session(1, Johnson))

# cs460 = Course('cs460', 4, [cs301], False, 0)

cs473 = Course('cs473', 4, [cs361, cs427], False, 0)
cs473.session(Session(2, Andonie))

# cs456 = Course('cs456', 4, [cs420], False, 0)

cs457 = Course('cs457', 4, [cs302, cs362], False, 0)
cs457.session(Session(3, Andonie))
cs457.session(Session(6, Andonie))

cs445 = Course('cs445', 4, [cs440], False, 0)
cs445.session(Session(8, Kovalerchuk))

cs430 = Course('cs430', 4, None, False, 0)
cs430.session(Session(5, Andonie))

cs471 = Course('cs471', 4, None, False, 0)
cs471.session(Session(7, Davendra))
